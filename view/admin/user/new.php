...
<div class="col-md-8">
<h2>Tambah User</h2>
<form action="process.php?p=user&&b=new" method="post" enctype="multipart/form-data">
	...
	<input type="password" name="pas" id="pas" class="form-control" onkeyup="cek()" onkeydown="cek()">
