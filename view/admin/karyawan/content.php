...
?>
<tr><th>Kode Karyawan</th><th>Nama Karyawan</th><th>Alamat</th><th>Cabang</th><th>Shift</th><th>Foto</th><th>Control</th></tr>
<?php
...
<tr><td><?php echo $isi["kd_karyawan"];?></td>
	...
	<td><input type="button" class="button_edit" title="edit data" onclick="window.location.href='index.php?p=karyawan&&b=edit&&kd_karyawan=<?php echo $isi["kd_karyawan"];?>'">
