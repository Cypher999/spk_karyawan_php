...
<div class="row">
			<div class="col">
		<input type="button" title="Tambah Data" class="button_add" onclick="window.location.href='index.php?p=karyawan&&b=new';">
		</div>
		<div class="col">
...
<script>
	my_function=new custom_ajax_function("karyawan");
