...
$jml_all=0;
?>
<tr><th>Kode Kriteria</th><th>Nama Kriteria</th><th>Tipe</th><th>Bobot</th><th>Control</th></tr>
<?php
...
<tr><td><?php echo $isi["kd_kriteria"];?></td>
	...
	<td><input type="button" class="button_edit" title="edit data" onclick="window.location.href='index.php?p=kriteria&&b=edit&&kd_kriteria=<?php echo $isi["kd_kriteria"];?>'">
