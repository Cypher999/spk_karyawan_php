...
<div class="row">
			<div class="col">
		<input type="button" title="Tambah Data" class="button_add" onclick="window.location.href='index.php?p=cabang&&b=new';">
		</div>
		<div class="col">
		<input type="text" placeholder="cari data" id="cari" class="form-control" onkeyup="cari_data()">
	</div>
</div>
		<table class="table table-stripped table-bordered col-md-8" id="table_isi">
			
		</table>
	</div>
		<script src="assets/js/function_ajax.js"></script>
<script>
	my_function=new custom_ajax_function("cabang");
